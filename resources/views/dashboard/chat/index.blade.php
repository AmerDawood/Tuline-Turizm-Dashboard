                    ...
                    <div class="tab-pane active" id="chats" role="tabpanel">
                        <div class="chat-room-list pt-3" data-simplebar style="max-height: calc(100vh - 308px);">
                            <div class="d-flex align-items-center px-4 mb-2">
                                <div class="flex-grow-1">
                                    <h4 class="mb-0 fs-11 text-muted text-uppercase">Amer Dawood</h4>
                                </div>
                                <div class="flex-shrink-0">
                                    <div data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="bottom" title="New Message">
                                        ...
                                        <button type="button" class="btn btn-soft-success btn-sm">
                                            <i class="ri-add-line align-send"></i>
                                        </button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="d-flex align-items-center px-4 mt-4 pt-2 mb-2">
                                <div class="flex-grow-1">
                                    <h4 class="mb-0 fs-11 text-muted text-uppercase">Ahmad</h4>
                                </div>
                                <div class="flex-shrink-0">
                                                ...
                                                <div class="flex-grow-1 overflow-hidden">
                                                    <div class="d-flex align-items-center">
                                                        <div class="flex-shrink-0 chat-user-img online user-own-img align-self-center me-3 ms-0">
                                                            <img src="https://placehold.co/600x400" class="rounded-circle avatar-xs" alt="">
