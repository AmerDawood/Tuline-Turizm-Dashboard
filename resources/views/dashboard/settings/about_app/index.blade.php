            ...
            <div class="col-lg-10">
                <div class="card">
                    <div class="bg-soft-warning position-relative">
                        <div class="card-body p-5">
                            <div class="text-center">
                                <h3 class="fw-semibold">About App</h3>
                                <p class="mb-0 text-muted">Last update: {{ $about->updated_at->diffForHumans() }}</p>
                            </div>
                        </div>
                        <div class="shape">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="text-end">
                            <a href="{{ route('aboutApp.update') }}" class="btn btn-primary">Update About App</a>
                        </div>
                    </div>
                </div>
            </div>
